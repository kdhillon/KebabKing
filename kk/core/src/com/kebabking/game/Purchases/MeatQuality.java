...
//				// name, initial cost, daily cost, qual factor, description		
				...
				new Quality  ("Grade A Meat", 	150, 2, 1.1f,	 "Delicious stuff. Still not sure where it came from, but tastes great. Animals."),
				new Quality  ("Grade AA Meat", 	500, 3, 1.2f,	 "A bit better; still tastes kinda fishy."), 
