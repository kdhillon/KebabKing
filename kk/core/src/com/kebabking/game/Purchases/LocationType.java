...
public class LocationType extends PurchaseType {
	...
	public static class Location extends SimplePurchaseable {
		...
		new Location(	new double[] {2,	0.5,	2,	0.1,	0.5,	0,		0.1,	0.1,	.1,	.5,	JEWELER_PROB},1, 0, 0, 0, 0, "village"),
		new Location(	new double[] {2,	0.2,	1,	0.1,	0.5,	0.1,	0.1,	0.1,	.4,	2,	JEWELER_PROB},1, 0, 3, 250, 3, "paddy"),
		
		new Location(	new double[] {2,	0.4,	1.5,0.4,	0.5,	0.2,	0.3,	0.3,	.4,	.1,	JEWELER_PROB},2, 0, 6, 0, 10, "suburbs"),
		new Location(	new double[] {2,	0.4,	1,	0.4,	0.5,	0.1,	0.5, 	0.3,	.4,	.1,	JEWELER_PROB},2, 0, 9, 200, 10, "subway"),
		new Location(	new double[] {2,	0.6,	1.5,0.4,	0.5,	0.1,	0.2,	0.2,	.4,	.1,	JEWELER_PROB},2, 0, 12, 250, 10, "urbancomplex"),
		
		new Location(	new double[] {2,	0.6,	1.5,0.4,	0.5,	0.2,	0.3,	0.3,	.4,	.1,	JEWELER_PROB},3, 10, 15, 0, 15,  "smallcity"),
		new Location(	new double[] {1,	0.7,	0.6,2,		0.8,	0.7,	0.4,	0.2,	.8,	.1,	JEWELER_PROB},3, 10, 18, 0, 20, "university"),
		new Location(	new double[] {2,	0.6,	1,	0.5,	0.4,	1.5,	0.5,	0.5,	.3,	.3,	JEWELER_PROB},3, 10, 21, 300, 20, "birdsnest"),
		
		new Location(	new double[] {1,	0.6,	1.5,0.7,	0.4,	0.5,	0.5,	0.2,	.5,	.4,	JEWELER_PROB},4, 20, 24, 350, 40, "temple"),
		new Location(	new double[] {1,	0.7,	0.1,0.8,	1.2,	0.9,	0.5,	0.2,	.9,	0,	JEWELER_PROB},4, 20, 27, 0, 30, "nightclub"),
		new Location(	new double[] {2,	0.6,	1,	0.5,	0.4,	0.5,	0.5,	0.3,	.3,	.3,	JEWELER_PROB},4, 20, 30, 400, 40,"drum"),
		
		new Location(	new double[] {2,	0.6,	1,	0.5,	0.4,	2,		0.5,	0.7,	.3,	.3,	JEWELER_PROB},5, 30, 33, 0, 40, "forbidden"),
		new Location(	new double[] {2,	0.6,	1,	0.5,	0.4,	2,		0.5,	0.5,	.3,	0,	JEWELER_PROB},5, 40, 36, 400, 40, "summerpalace"),
		new Location(	new double[] {2,	0.6,	0.4,0.5,	0.4,	0.5,	0.5,	0.2,	1.5,0,	JEWELER_PROB},5, 40, 39, 0, 40, "shanghai"),
		new Location(	new double[] {2,	0.6,	1,	0.5,	0.4,	2,		0.5,	0.5,	.3,	0,	JEWELER_PROB},5, 40, 42, 0, 30, "terracotta"),
		new Location(	new double[] {2,	1.0,	1,	0.5,	0.4,	1.5,	0.5,	0.5,	.3,	0,	JEWELER_PROB},5, 40, 45, 400, 40, "panda"),
		new Location(	new double[] {2,	0.6,	1,	0.5,	0.4,	0.5,	0.5,	0.5,	.3,	0.5,JEWELER_PROB},5, 40, 48, 0, 5, "silkroad"),
		new Location(	new double[] {2,	0.5,	0,	0.2,	0.4,	0.5,	0.5,	0.5,	2,	0,	JEWELER_PROB},5, 40, 50, 500, 50, "cbd")
		};
