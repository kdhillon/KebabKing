...
//				new Type("charcoal", 		500, 	0,  6, 0.9f, 0.9f, false), 
				new Type("gas", 			1000, 	10,  13,5, 0.85f,  0.9f, false),
				new Type("gas_warmer", 		2500, 	15, 21,8, 0.85f, 	0.9f, true),
				new Type("electric", 		5000,	20, 32,11, 0.75f, 	0.8f, false),
				new Type("electric_warmer",	5000, 	25, 41,14, 0.75f, 	0.8f, true),
				new Type("nuclear", 		10000, 	35, 47,16, 0.65f, 	0.7f, false),
		};
