...
//public class SummaryScreenOld extends ScreenTemplate  {
...
//	Label dayComplete;
//
//	public SummaryScreenOld(KitchenScreen kitchen) {
...
//		timeElapsed = 0;
//		
//		dayComplete = new Label("Day Complete!", Assets.generateLabelStyleUIChinaWhite(KebabKing.getGlobalX(60.f / 480)));
...
//		Manager.analytics.sendEventHit("Day", "End", kitchen.master.profile.getLocation().getName());
//		
//		initializeTable();
//		
//		// TESTING
//		grantExpForProfit(profit);
//		grantExpForProfit(10);
//		grantExpForProfit(30);
//		grantExpForProfit(400);
//		grantExpForProfit(100);
//		grantExpForProfit(110);
//	}
//
//	@Override
...
//		
//		
//		table.setSize(KebabKing.getGlobalX(3.0f / 4), KebabKing.getGlobalY(3.0f / 4));
//		table.setPosition((KebabKing.getWidth() - table.getWidth())/2, (KebabKing.getHeight() - table.getHeight())/2);
//		table.setBackground(Assets.uiSkin.getDrawable("textbox_01"));
//		table.top();
//		
//		uiStage.addActor(table);
//		
//		Label title = new Label("Day " + getProfile().daysWorked + ":", Assets.generateLabelStyleUIChinaWhite(60));
//		table.add(title).colspan(2);
//		
//		labelPad = KebabKing.getGlobalY(0.01f);
//				
//		addLabelLeft("Revenue:");
//		revenueR = new Label("", Assets.generateLabelStyleUIChinaWhite(32));
//		table.add(revenueR).padTop(labelPad).expandX().right();
//		addLabelLeft("Expenses:");
//		expensesR = new Label("", Assets.generateLabelStyleUIChinaWhite(32));
//		table.add(expensesR).padTop(labelPad).expandX().right();
//		addLabelLeft("Rent:");
//		rentR = new Label("", Assets.generateLabelStyleUIChinaWhite(32));
//		table.add(rentR).padTop(labelPad).expandX().right();
//		
//		
//		addLabelLeft("Profit:");
//		profitR = new Label("", Assets.generateLabelStyleUIChinaWhite(32));
//		table.add(profitR).padTop(labelPad).expandX().right();
//		addLabelLeft("Customers:");
//		customersServedR = new Label("", Assets.generateLabelStyleUIChinaWhite(32));
//		table.add(customersServedR).padTop(labelPad).expandX().right();
//		addLabelLeft("Sick:");
//		sickCountR = new Label("", Assets.generateLabelStyleUIChinaWhite(32));
...
//		
//		tapToContinue = new Label("", Assets.generateLabelStyleUIChinaWhite(32));
//		table.row();
...
//		table.row();
//		Label l = new Label(s, Assets.generateLabelStyleUIChinaWhite(32));
